...
const func = async (hre) => {
    ...
    await rollupCreator.setTemplates(bridgeCreator.address, rollup.address, challengeFactory.address, nodeFactory.address, RollupAdminFacet.address, RollupUserFacet.address);
};
module.exports = func;
