...
var ICONS = {
  add: async () => (await import("./add-2QGB57FH.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-R4MSKRAQ.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-4RWDVQ76.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-Z4XJSNI5.js")).appStoreSvg,
  apple: async () => (await import("./apple-MQ7QVDPT.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-HY6BC7YE.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-25WIDN3N.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-YI2ITD6R.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-UO7OVLY4.js")).arrowTopSvg,
  bank: async () => (await import("./bank-NEVFSMAU.js")).bankSvg,
  browser: async () => (await import("./browser-T5AUS24R.js")).browserSvg,
  card: async () => (await import("./card-ED627XNE.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-IRMFYBUY.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-GHZEZJVQ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-KOIPGNGZ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-TTDUFU6K.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-6QF3UWVE.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-Y5LTC6OI.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-57JEDO73.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-X3QA3MKC.js")).clockSvg,
  close: async () => (await import("./close-VXCRVWY4.js")).closeSvg,
  compass: async () => (await import("./compass-KG73TVFO.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-PKNGKXVD.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-LSH6EOE6.js")).copySvg,
  cursor: async () => (await import("./cursor-FQEL23PC.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-JOX2IOJE.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-KWHZA3FD.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-OHI2Q2JP.js")).disconnectSvg,
  discord: async () => (await import("./discord-6YINZZ5J.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-QDB6B2WV.js")).etherscanSvg,
  extension: async () => (await import("./extension-3ITG3W5Y.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-TJ5VPERC.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-P6HIQ2TK.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-G6I4AS5L.js")).farcasterSvg,
  filters: async () => (await import("./filters-NBYAQCL2.js")).filtersSvg,
  github: async () => (await import("./github-XWJIBUUR.js")).githubSvg,
  google: async () => (await import("./google-YQP6VHOL.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-QRUKTTQZ.js")).helpCircleSvg,
  image: async () => (await import("./image-2OJSDRAL.js")).imageSvg,
  id: async () => (await import("./id-3Z3IOC6H.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-3X5RAFZZ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-UMIE6BGG.js")).lightbulbSvg,
  mail: async () => (await import("./mail-AUHXUIC7.js")).mailSvg,
  mobile: async () => (await import("./mobile-NHEOHS5G.js")).mobileSvg,
  more: async () => (await import("./more-GPT4PY6W.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-5SNXN35L.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-3V4UHQDH.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-GBC7WQ7M.js")).offSvg,
  playStore: async () => (await import("./play-store-IAWMRL6Q.js")).playStoreSvg,
  plus: async () => (await import("./plus-IX7LVWBD.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-6Y7DLBJ5.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-6SYRUWVN.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-IW5D7GB6.js")).refreshSvg,
  search: async () => (await import("./search-7L44TXGZ.js")).searchSvg,
  send: async () => (await import("./send-JWOKH6LO.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-KTGU7EIQ.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-YLDG354L.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-EFPRU4PQ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-S5QREXIA.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-WRFI4LBX.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-FVFSXTVZ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-GCJDVUIY.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-WDQIUI24.js")).twitchSvg,
  twitter: async () => (await import("./x-L2K362NW.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-LDGND475.js")).twitterIconSvg,
  verify: async () => (await import("./verify-26X5G57U.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-IVB76MRB.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-AKOEYZRB.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CSN3SVSK.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CSN3SVSK.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CSN3SVSK.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-C7VRKSJE.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-FBUSRU3S.js")).warningCircleSvg,
  x: async () => (await import("./x-L2K362NW.js")).xSvg,
  info: async () => (await import("./info-QVDNTOPM.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-S67UL5G5.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-5773C65N.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ELXMA4MX.js.map
