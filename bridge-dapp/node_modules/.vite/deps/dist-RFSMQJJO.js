...
import {
  ...
  l,
  y
} from "./chunk-4RKJFR4R.js";
import "./chunk-6R2GRWPM.js";
import {
  arbitrum,
  avalanche,
  base,
  ...
  sepolia,
  zora
} from "./chunk-ZJUZHKSK.js";
import {
  createJSONStorage,
  createStore,
  persist
} from "./chunk-U3FYDVIJ.js";
import {
...
import {
  ...
  readContract,
  waitForCallsStatus
} from "./chunk-PFJ43YXG.js";
import {
  defineChain
} from "./chunk-XE3JZRAD.js";
import "./chunk-76Z35AJV.js";
import "./chunk-YE6ZKA2U.js";
import {
  decodeFunctionData,
  encodeFunctionData,
  isAddressEqual
} from "./chunk-UA3EY2OK.js";
import {
  BaseError,
  decodeAbiParameters,
  encodeAbiParameters,
  ...
  toHex,
  trim
} from "./chunk-H5ZLNTNU.js";
import "./chunk-NSDO7JQ5.js";
import "./chunk-DRC7ECUX.js";
import {
  __publicField
...
var initCCA = () => {
  if (typeof window !== "undefined") {
    const deviceId = store.config.get().deviceId ?? (crypto == null ? void 0 : crypto.randomUUID()) ?? "";
    if (window.ClientAnalytics) {
...
function logEvent(name, event, importance) {
  ...
  if (typeof window !== "undefined" && window.ClientAnalytics) {
    (_b = window.ClientAnalytics) == null ? void 0 : _b.logEvent(name, {
      ...event,
      sdkVersion: PACKAGE_VERSION,
      sdkName: PACKAGE_NAME,
      appName: ((_a = store.config.get().metadata) == null ? void 0 : _a.appName) ?? "",
...
// node_modules/@base-org/account/node_modules/clsx/dist/clsx.m.js
function r(e) {
  var t, f2, n = "";
...
var Dialog = class {
  constructor() {
    ...
    __publicField(this, "nextItemKey", 0);
  ...
  render() {
    if (this.root) {
      B(u("div", { children: u(DialogContainer, { children: Array.from(this.items.entries()).map(([key, itemProps]) => _(DialogInstance, { ...itemProps, key, handleClose: () => {
        var _a;
        this.clear();
        (_a = itemProps.onClose) == null ? void 0 : _a.call(itemProps);
      } })) }) }), this.root);
    }
  }
};
...
var DialogInstance = ({ title, message, actionItems, handleClose }) => {
  ...
  y(() => {
    const fetchEnsName = async () => {
      var _a;
      const address = (_a = store.account.get().accounts) == null ? void 0 : _a[0];
      if (address) {
...
function openPopupWithDialog(tryOpenPopup) {
  var _a;
  const dappName = ((_a = store.config.get().metadata) == null ? void 0 : _a.appName) ?? "App";
...
var Communicator = class {
  constructor({ url = CB_KEYS_URL, metadata, preference }) {
     ...
     */
    __publicField(this, "postMessage", async (message) => {
     ...
     */
    __publicField(this, "postRequestAndWaitForResponse", async (request) => {
     ...
     */
    __publicField(this, "onMessage", async (predicate) => {
      return new Promise((resolve, reject) => {
     ...
     */
    __publicField(this, "waitForPopupLoaded", async () => {
...
var logHandshakeStarted = ({ method, correlationId }) => {
  ...
  logEvent("scw_signer.handshake.started", {
    ...
    method,
    correlationId,
    subAccountCreation: config2 == null ? void 0 : config2.creation,
    subAccountDefaultAccount: config2 == null ? void 0 : config2.defaultAccount,
    subAccountFunding: config2 == null ? void 0 : config2.funding
  }, AnalyticsEventImportance.high);
};
...
function getFallbackRpcUrl(chainId) {
  ...
  if ((_c = (_b = (_a = viemChain == null ? void 0 : viemChain.rpcUrls) == null ? void 0 : _a.default) == null ? void 0 : _b.http) == null ? void 0 : _c[0]) {
...
function defineChainConfig(chainId, rpcUrl, options) {
  var _a, _b;
  const viemChain = options == null ? void 0 : options.viemChain;
  const nativeCurrency = options == null ? void 0 : options.nativeCurrency;
  const name = (nativeCurrency == null ? void 0 : nativeCurrency.name) ?? (viemChain == null ? void 0 : viemChain.name) ?? "";
  const symbol = (nativeCurrency == null ? void 0 : nativeCurrency.symbol) ?? ((_a = viemChain == null ? void 0 : viemChain.nativeCurrency) == null ? void 0 : _a.symbol) ?? "";
  const decimals = (nativeCurrency == null ? void 0 : nativeCurrency.decimal) ?? ((_b = viemChain == null ? void 0 : viemChain.nativeCurrency) == null ? void 0 : _b.decimals) ?? 18;
  return defineChain({
    id: chainId,
    name,
    nativeCurrency: {
...
function getClient(chainId) {
  var _a;
  const storedClient = (_a = ChainClients.getState()[chainId]) == null ? void 0 : _a.client;
  if (storedClient) {
    return storedClient;
  }
...
var correlationIdsStore = createStore(() => ({
...
function createStorage(scope, name) {
  const store2 = typeof indexedDB !== "undefined" ? createStore2(scope, name) : void 0;
  return {
    getItem: async (key) => {
...
var SCWKeyManager = class {
  constructor() {
    __publicField(this, "ownPrivateKey", null);
    __publicField(this, "ownPublicKey", null);
    __publicField(this, "peerPublicKey", null);
...
function getSenderFromRequest(request) {
  ...
  switch (request.method) {
    ...
    case "wallet_sendCalls":
      return (_a = request.params[0]) == null ? void 0 : _a.from;
    default:
      return null;
  }
}
...
function assertParamsChainId(params) {
  var _a;
  if (!params || !Array.isArray(params) || !((_a = params[0]) == null ? void 0 : _a.chainId)) {
    throw standardErrors.rpc.invalidParams();
  }
...
function fillMissingParamsForFetchPermissions(request) {
  ...
  const accountFromStore = (_a = store.getState().account.accounts) == null ? void 0 : _a[0];
  const chainId = (_b = store.getState().account.chain) == null ? void 0 : _b.id;
  const subAccountFromStore = (_c = store.getState().subAccount) == null ? void 0 : _c.address;
...
async function waitForCallsTransactionHash({ client, id }) {
  ...
  if (result.status === "success") {
    return (_a = result.receipts) == null ? void 0 : _a[0].transactionHash;
  }
...
function createWalletSendCallsRequest({ calls, from, chainId, capabilities }) {
  ...
  if (paymasterUrls == null ? void 0 : paymasterUrls[chainId]) {
    request = injectRequestCapabilities(request, {
      paymasterService: { url: paymasterUrls == null ? void 0 : paymasterUrls[chainId] }
    });
  }
  return request;
}
...
function asn1EncodeSignature(r2, s) {
  const rBytes = hexToBytes(trim(numberToHex(r2)));
...
function toWebAuthnSignature({ webauthn, signature }) {
  const { r: r2, s } = fromHex(signature);
    ...
    try {
      switch (args.method) {
        ...
        case "wallet_sendCalls": {
          ...
          const signResponse = await ((_a2 = owner.sign) == null ? void 0 : _a2.call(owner, {
...
async function presentAddOwnerDialog() {
  var _a;
  const appName = ((_a = store.config.get().metadata) == null ? void 0 : _a.appName) ?? "App";
  const dialog2 = initDialog();
...
async function handleAddSubAccountOwner({ ownerAccount, globalAccountRequest, chainId }) {
  ...
  const globalAccount = (_a = account2.accounts) == null ? void 0 : _a.find((account3) => account3.toLowerCase() !== (subAccount == null ? void 0 : subAccount.address.toLowerCase()));
  assertPresence(globalAccount, standardErrors.provider.unauthorized("no global account"));
  assertPresence((_b = account2.chain) == null ? void 0 : _b.id, standardErrors.provider.unauthorized("no chain id"));
  assertPresence(subAccount == null ? void 0 : subAccount.address, standardErrors.provider.unauthorized("no sub account"));
  const calls = [];
...
async function routeThroughGlobalAccount({ request, globalAccountAddress, subAccountAddress, client, globalAccountRequest, chainId, prependCalls }) {
  ...
  if ((_a = result.capabilities) == null ? void 0 : _a.spendPermissions) {
...
var Signer = class {
  constructor(params) {
    ...
    this.chain = account2.chain ?? {
      id: ((_a = params.metadata.appChainIds) == null ? void 0 : _a[0]) ?? 1
    };
    if (chains2) {
  ...
  async handshake(args) {
    ...
    try {
      await ((_b = (_a = this.communicator).waitForPopupLoaded) == null ? void 0 : _b.call(_a));
  ...
  async _request(request) {
    ...
    if (this.accounts.length === 0) {
      switch (request.method) {
        ...
        case "wallet_connect": {
          ...
          const modifiedRequest = injectRequestCapabilities(request, (subAccountsConfig2 == null ? void 0 : subAccountsConfig2.capabilities) ?? {});
    ...
    switch (request.method) {
      ...
      case "eth_accounts": {
        const subAccount = store.subAccounts.get();
        const subAccountsConfig2 = store.subAccountsConfig.get();
        if (subAccount == null ? void 0 : subAccount.address) {
          this.accounts = (subAccountsConfig2 == null ? void 0 : subAccountsConfig2.defaultAccount) === "sub" ? prependWithoutDuplicates(this.accounts, subAccount.address) : appendWithoutDuplicates(this.accounts, subAccount.address);
        }
        (_c = this.callback) == null ? void 0 : _c.call(this, "connect", { chainId: numberToHex(this.chain.id) });
      ...
      case "wallet_grantPermissions":
        return this.sendRequestToPopup(request);
      case "wallet_connect": {
        await ((_e = (_d = this.communicator).waitForPopupLoaded) == null ? void 0 : _e.call(_d));
        await initSubAccountConfig();
        const subAccountsConfig2 = store.subAccountsConfig.get();
        const modifiedRequest = injectRequestCapabilities(request, (subAccountsConfig2 == null ? void 0 : subAccountsConfig2.capabilities) ?? {});
        const result = await this.sendRequestToPopup(modifiedRequest);
        (_f = this.callback) == null ? void 0 : _f.call(this, "connect", { chainId: numberToHex(this.chain.id) });
        return result;
      }
      ...
      case "coinbase_fetchPermissions": {
        ...
        const requestedChainId = hexToNumber((_g = completeRequest.params) == null ? void 0 : _g[0].chainId);
  ...
  async handleResponse(request, decrypted) {
    ...
    switch (request.method) {
      case "eth_requestAccounts": {
        ...
        (_a = this.callback) == null ? void 0 : _a.call(this, "accountsChanged", accounts);
        break;
      }
      case "wallet_connect": {
        ...
        const capabilities = account2 == null ? void 0 : account2.capabilities;
        if (capabilities == null ? void 0 : capabilities.subAccounts) {
          const capabilityResponse = capabilities == null ? void 0 : capabilities.subAccounts;
        ...
        const spendPermissions2 = (_c = (_b = response == null ? void 0 : response.accounts) == null ? void 0 : _b[0].capabilities) == null ? void 0 : _c.spendPermissions;
        if (spendPermissions2 && "permissions" in spendPermissions2) {
          store.spendPermissions.set(spendPermissions2 == null ? void 0 : spendPermissions2.permissions);
        }
        (_d = this.callback) == null ? void 0 : _d.call(this, "accountsChanged", this.accounts);
        break;
      }
      case "wallet_addSubAccount": {
        ...
        const subAccountsConfig2 = store.subAccountsConfig.get();
        this.accounts = (subAccountsConfig2 == null ? void 0 : subAccountsConfig2.defaultAccount) === "sub" ? prependWithoutDuplicates(this.accounts, subAccount.address) : appendWithoutDuplicates(this.accounts, subAccount.address);
        (_e = this.callback) == null ? void 0 : _e.call(this, "accountsChanged", this.accounts);
        break;
      }
      default:
        break;
  ...
  async cleanup() {
    ...
    this.accounts = [];
    this.chain = {
      id: ((_a = metadata == null ? void 0 : metadata.appChainIds) == null ? void 0 : _a[0]) ?? 1
    };
  }
  /**
  ...
  async decryptResponseMessage(message) {
    ...
    const availableChains = (_a = response.data) == null ? void 0 : _a.chains;
    if (availableChains) {
      const nativeCurrencies = (_b = response.data) == null ? void 0 : _b.nativeCurrencies;
      const chains2 = Object.entries(availableChains).map(([id, rpcUrl]) => {
        const nativeCurrency = nativeCurrencies == null ? void 0 : nativeCurrencies[Number(id)];
        return {
          id: Number(id),
          rpcUrl,
    ...
    const walletCapabilities = (_c = response.data) == null ? void 0 : _c.capabilities;
  ...
  updateChain(chainId, newAvailableChains) {
    ...
    const chain = chains2 == null ? void 0 : chains2.find((chain2) => chain2.id === chainId);
    if (!chain)
      return false;
    if (chain !== this.chain) {
      this.chain = chain;
      ...
      (_a = this.callback) == null ? void 0 : _a.call(this, "chainChanged", hexStringFromNumber(chain.id));
    }
    return true;
  }
  async addSubAccount(request) {
    ...
    if (subAccount == null ? void 0 : subAccount.address) {
      this.accounts = (subAccountsConfig2 == null ? void 0 : subAccountsConfig2.defaultAccount) === "sub" ? prependWithoutDuplicates(this.accounts, subAccount.address) : appendWithoutDuplicates(this.accounts, subAccount.address);
      (_a = this.callback) == null ? void 0 : _a.call(this, "accountsChanged", this.accounts);
      return subAccount;
    }
    await ((_c = (_b = this.communicator).waitForPopupLoaded) == null ? void 0 : _c.call(_b));
  ...
  shouldRequestUseSubAccountSigner(request) {
    ...
    const subAccount = store.subAccounts.get();
    if (sender) {
      return sender.toLowerCase() === (subAccount == null ? void 0 : subAccount.address.toLowerCase());
    }
    return false;
  }
  async sendRequestToSubAccountSigner(request) {
    ...
    assertPresence(subAccount == null ? void 0 : subAccount.address, standardErrors.provider.unauthorized("no active sub account when sending request to sub account signer"));
    const ownerAccount = (subAccountsConfig2 == null ? void 0 : subAccountsConfig2.toOwnerAccount) ? await subAccountsConfig2.toOwnerAccount() : await getCryptoKeyAccount();
    assertPresence(ownerAccount == null ? void 0 : ownerAccount.account, standardErrors.provider.unauthorized("no active sub account owner when sending request to sub account signer"));
    const sender = getSenderFromRequest(request);
    if (sender === void 0) {
    ...
    const dataSuffix = makeDataSuffix({
      attribution: (_a = config2.preference) == null ? void 0 : _a.attribution,
      dappOrigin: window.location.origin
    });
    const walletSendCallsChainId = request.method === "wallet_sendCalls" && ((_c = (_b = request.params) == null ? void 0 : _b[0]) == null ? void 0 : _c.chainId);
    ...
    if (["eth_sendTransaction", "wallet_sendCalls"].includes(request.method)) {
      ...
      if ((subAccountsConfig3 == null ? void 0 : subAccountsConfig3.funding) === "spend-permissions") {
    ...
    try {
      ...
      const subAccountsConfig3 = store.subAccountsConfig.get();
      if ((subAccountsConfig3 == null ? void 0 : subAccountsConfig3.funding) === "manual") {
        throw error;
      }
      let errorObject;
      if (isViemError(error)) {
...
var BaseAccountProvider = class extends ProviderEventEmitter {
  constructor({ metadata, preference: { walletUrl, ...preference } }) {
    ...
    __publicField(this, "isBaseAccount", true);
              ...
              params: [
                {
                  version: "1",
                  capabilities: {
                    ...((_a = store.subAccountsConfig.get()) == null ? void 0 : _a.capabilities) ?? {}
                  }
                }
              ]
            });
...
function getInjectedProvider() {
  var _a;
  const injectedProvider = ((_a = window.top) == null ? void 0 : _a.ethereum) ?? window.ethereum;
  if (injectedProvider == null ? void 0 : injectedProvider[TBA_PROVIDER_IDENTIFIER]) {
...
function createBaseAccountSDK(params) {
  ...
  if ((_a = params.subAccounts) == null ? void 0 : _a.toOwnerAccount) {
    validateSubAccount(params.subAccounts.toOwnerAccount);
  }
  store.subAccountsConfig.set({
    toOwnerAccount: (_b = params.subAccounts) == null ? void 0 : _b.toOwnerAccount,
    creation: ((_c = params.subAccounts) == null ? void 0 : _c.creation) ?? "manual",
    defaultAccount: ((_d = params.subAccounts) == null ? void 0 : _d.defaultAccount) ?? "universal",
    funding: ((_e = params.subAccounts) == null ? void 0 : _e.funding) ?? "spend-permissions"
  });
  ...
  const sdk = {
    ...
    subAccount: {
      async create(accountParam) {
        var _a2;
        return await ((_a2 = sdk.getProvider()) == null ? void 0 : _a2.request({
      ...
      async get() {
        ...
        const response = await ((_a2 = sdk.getProvider()) == null ? void 0 : _a2.request({
          method: "wallet_connect",
          params: [
            {
              version: "1",
        ...
        const subAccounts2 = (_b2 = response.accounts[0].capabilities) == null ? void 0 : _b2.subAccounts;
      ...
      addOwner: async ({ address, publicKey, chainId }) => {
        ...
        assertPresence(subAccount == null ? void 0 : subAccount.address, new Error("subaccount does not exist"));
        const calls = [];
        if (publicKey) {
        ...
        return await ((_b2 = sdk.getProvider()) == null ? void 0 : _b2.request({
          method: "wallet_sendCalls",
          params: [
            {
              calls,
              chainId: toHex(chainId),
              from: (_a2 = account2.accounts) == null ? void 0 : _a2[0],
              version: "1"
            }
          ]
        }));
...
async function getPaymentStatus(options) {
  ...
  try {
    ...
    if (success) {
      let amount;
      let recipient;
      if (txReceipt == null ? void 0 : txReceipt.logs) {
        ...
        const usdcTransfers = [];
        for (let i2 = 0; i2 < txReceipt.logs.length; i2++) {
          const log = txReceipt.logs[i2];
          const logAddressLower = (_a = log.address) == null ? void 0 : _a.toLowerCase();
        ...
        if (usdcTransfers.length > 0 && senderAddress) {
          ...
          if (senderTransfers.length > 1) {
            const transferDetails = senderTransfers.map((t) => `${t.formattedAmount} USDC to ${t.to}`).join(", ");
...
function withTelemetry(fn) {
  var _a;
  const config2 = store.config.get();
  if (((_a = config2.preference) == null ? void 0 : _a.telemetry) === false) {
    return fn;
  }
  return (...args) => {
...
function createSpendPermissionTypedDataWithSeconds(request) {
  ...
  if (false) {
    console.warn("⚠️ createSpendPermissionTypedDataWithSeconds is being used. This function is intended for testing purposes only.");
  }
  return {
    domain: {
      name: "Spend Permission Manager",
...
var getPermissionStatusFn = async (permission) => {
...
var prepareSpendCallDataFn = async (permission, amount, recipient) => {
...
var requestSpendPermissionFn = async (request) => {
  const { provider, account: account2, chainId } = request;
...
async function executePayment(sdk, requestParams) {
  ...
  if (typeof result === "string" && result.length >= 66) {
    ...
    if (typeof resultObj.id === "string" && resultObj.id.length >= 66) {
      ...
      if ((_a = resultObj.capabilities) == null ? void 0 : _a.dataCallback) {
...
async function pay(options) {
  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      } else if (typeof ((_a = err == null ? void 0 : err.error) == null ? void 0 : _a.message) === "string") {
        errorMessage = err.error.message;
      } else if (typeof (err == null ? void 0 : err.reason) === "string") {
...
//# sourceMappingURL=dist-RFSMQJJO.js.map
