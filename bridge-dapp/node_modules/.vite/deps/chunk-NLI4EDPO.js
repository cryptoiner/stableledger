...
} from "./chunk-VKRMPPVL.js";
import {
  require_fast_safe_stringify,
  require_semver
} from "./chunk-7AB7MCIX.js";
import {
  require_browser
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-RFSMQJJO.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-64HOMTUP.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-TZEQGQKK.js");
...
var NumberLikeStruct = union([number2(), bigint(), string(), StrictHexStruct]);
var NumberCoercer = coerce(number2(), NumberLikeStruct, Number);
...
var JsonRpcIdStruct = nullable(union([number2(), string()]));
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-OOMJGXF4.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
// node_modules/porto/dist/trusted-hosts.js
    ...
    return {
              ...
              params: [
                {
                  ..."capabilities" in rest ? {
                    capabilities: mini_exports.encode(RpcSchema_exports.wallet_connect.Capabilities, rest.capabilities ?? {})
                  } : {},
                  chainIds: [
                    numberToHex(chainId),
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-72CEAZSS.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-IXEOYH3W.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-AKWKNKM6.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-HTVNK4TG.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NLI4EDPO.js.map
