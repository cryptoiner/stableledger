...
function base(ALPHABET2) {
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i3 = 0;
      for (let it32 = size4 - 1; (carry !== 0 || i3 < length) && it32 !== -1; it32--, i3++) {
      ...
      try {
        const u3 = new Promise(async (b5) => {
          ...
          const I4 = yi(new Promise((D3, j3) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h4, tag: l3, id: d3, attestation: n2 == null ? void 0 : n2.attestation, tvf: n2 == null ? void 0 : n2.tvf }).then(D3).catch((T3) => {
...
var D2 = async () => {
  const { createAppKit: s } = await import("./core-MCVMHDB7.js");
  return s;
};
...
function G3(s) {
  ...
  const c3 = { chains: t, methods: n2 || f6, events: a2 || C5, rpcMap: v4({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l3 = a2 == null ? void 0 : a2.filter((d3) => !C5.includes(d3)), r2 = n2 == null ? void 0 : n2.filter((d3) => !f6.includes(d3));
  if (!e && !o2 && !i3 && !(l3 != null && l3.length) && !(r2 != null && r2.length)) return { required: t.length ? c3 : void 0 };
  const m2 = (l3 == null ? void 0 : l3.length) && (r2 == null ? void 0 : r2.length) || !e, h4 = { chains: [...new Set(m2 ? c3.chains.concat(e || []) : e)], methods: [...new Set(c3.methods.concat(i3 != null && i3.length ? i3 : A4))], events: [...new Set(c3.events.concat(o2 != null && o2.length ? o2 : P3))], rpcMap: u3 };
...
var b4 = class _b {
  ...
  async connect(t) {
    ...
    try {
      const a2 = await new Promise(async (u3, c3) => {
        ...
        await this.signer.connect(w2(v4({ namespaces: v4({}, n2 && { [this.namespace]: n2 }) }, i3 && { optionalNamespaces: { [this.namespace]: i3 } }), { pairingTopic: t == null ? void 0 : t.pairingTopic, scopedProperties: m2 })).then((h4) => {
          u3(h4);
        }).catch((h4) => {
          var d3;
  ...
  getRpcConfig(t) {
    var e, n2;
    const i3 = (e = t == null ? void 0 : t.chains) != null ? e : [], a2 = (n2 = t == null ? void 0 : t.optionalChains) != null ? n2 : [], o2 = i3.concat(a2);
    if (!o2.length) throw new Error("No chains specified in either `chains` or `optionalChains`");
    const u3 = i3.length ? (t == null ? void 0 : t.methods) || f6 : [], c3 = i3.length ? (t == null ? void 0 : t.events) || C5 : [], l3 = (t == null ? void 0 : t.optionalMethods) || [], r2 = (t == null ? void 0 : t.optionalEvents) || [], m2 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(o2, t.projectId), h4 = (t == null ? void 0 : t.qrModalOptions) || void 0;
    return { chains: i3 == null ? void 0 : i3.map((d3) => this.formatChainId(d3)), optionalChains: a2.map((d3) => this.formatChainId(d3)), methods: u3, events: c3, optionalMethods: l3, optionalEvents: r2, rpcMap: m2, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: h4, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, e) {
    const n2 = {};
    return t.forEach((i3) => {
  ...
  loadConnectOpts(t) {
    ...
    })), n2 && se(n2) && (this.rpc.optionalChains = [], this.rpc.optionalChains = n2 == null ? void 0 : n2.map((a2) => this.formatChainId(a2)), n2.forEach((a2) => {
      this.rpc.rpcMap[a2] = (i3 == null ? void 0 : i3[a2]) || this.getRpcUrl(a2);
    }));
  }
  getRpcUrl(t, e) {
...
*/
//# sourceMappingURL=index.es-HTVNK4TG.js.map
