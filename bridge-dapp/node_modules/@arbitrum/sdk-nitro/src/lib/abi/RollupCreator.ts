...
export interface RollupCreatorInterface extends utils.Interface {
  ...
  functions: {
    ...
    "createRollup((uint64,uint64,address,uint256,bytes32,address,address,uint256,(uint256,uint256,uint256,uint256)),address)": FunctionFragment;
    "osp()": FunctionFragment;
    "owner()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "rollupAdminLogic()": FunctionFragment;
    "rollupUserLogic()": FunctionFragment;
    "setTemplates(address,address,address,address,address)": FunctionFragment;
