...
export interface IRollupEventBridgeInterface extends utils.Interface {
  contractName: "IRollupEventBridge";
  functions: {
...
export interface IRollupEventBridge extends BaseContract {
  contractName: "IRollupEventBridge";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRollupEventBridgeInterface;
