...
export interface ArbitrumProxyInterface extends utils.Interface {
  contractName: "ArbitrumProxy";
  functions: {};
...
export interface ArbitrumProxy extends BaseContract {
  contractName: "ArbitrumProxy";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArbitrumProxyInterface;
