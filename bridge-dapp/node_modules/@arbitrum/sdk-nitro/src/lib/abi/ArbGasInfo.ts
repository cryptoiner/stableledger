...
export interface ArbGasInfoInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getGasPoolSeconds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getGasPoolTarget",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getGasPoolWeight",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getRateEstimate",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getRateEstimateInertia",
    values?: undefined
  ): string;
