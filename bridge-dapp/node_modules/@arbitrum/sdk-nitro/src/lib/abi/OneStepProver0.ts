...
export type ExecutionContextStructOutput = [BigNumber, string, string] & {
...
export type PcArrayStruct = { inner: BigNumberish[] };

export type PcArrayStructOutput = [number[]] & { inner: number[] };

export type PcStackStruct = { proved: PcArrayStruct; remainingHash: BytesLike };

export type PcStackStructOutput = [PcArrayStructOutput, string] & {
  proved: PcArrayStructOutput;
  remainingHash: string;
};
...
export type MachineStructOutput = [
  ...
  blockStack: PcStackStructOutput;
...
export type ModuleMemoryStruct = { size: BigNumberish; merkleRoot: BytesLike };

export type ModuleMemoryStructOutput = [BigNumber, string] & {
  size: BigNumber;
  merkleRoot: string;
};
...
export interface OneStepProver0Interface extends utils.Interface {
  contractName: "OneStepProver0";
  functions: {
    "executeOneStep((uint256,address,address),(uint8,(((uint8,uint256)[]),bytes32),(((uint8,uint256)[]),bytes32),((uint32[]),bytes32),(((uint8,uint256),bytes32,uint32,uint32)[],bytes32),bytes32,uint32,uint32,uint32,bytes32),(bytes32,(uint64,bytes32),bytes32,bytes32,uint32),(uint16,uint256),bytes)": FunctionFragment;
  };
...
export interface OneStepProver0 extends BaseContract {
  contractName: "OneStepProver0";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneStepProver0Interface;
