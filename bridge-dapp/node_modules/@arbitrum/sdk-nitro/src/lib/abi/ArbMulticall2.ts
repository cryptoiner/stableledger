...
export declare namespace ArbMulticall2 {
...
export interface ArbMulticall2Interface extends utils.Interface {
  contractName: "ArbMulticall2";
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [ArbMulticall2.CallStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [boolean, ArbMulticall2.CallStruct[]]
  ): string;
  encodeFunctionData(
...
export interface ArbMulticall2 extends BaseContract {
  contractName: "ArbMulticall2";
  ...
  functions: {
    aggregate(
      calls: ArbMulticall2.CallStruct[],
  ...
  callStatic: {
    ...
    blockAndAggregate(
      ...
      [BigNumber, string, ArbMulticall2.ResultStructOutput[]] & {
        blockNumber: BigNumber;
        blockHash: string;
        returnData: ArbMulticall2.ResultStructOutput[];
      }
    >;
    ...
    tryAggregate(
      ...
      calls: ArbMulticall2.CallStruct[],
      overrides?: CallOverrides
    ): Promise<ArbMulticall2.ResultStructOutput[]>;
