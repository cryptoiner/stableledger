...
export interface RollupAdminLogicInterface extends utils.Interface {
  ...
  functions: {
    ...
    "initialize((uint64,uint64,address,uint256,bytes32,address,address,uint256,(uint256,uint256,uint256,uint256)),(address,address,address,address,address,address,address))": FunctionFragment;
    ...
    "setSequencerInboxMaxTimeVariation((uint256,uint256,uint256,uint256))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setSequencerInboxMaxTimeVariation",
...
export interface RollupAdminLogic extends BaseContract {
  ...
  functions: {
    ...
    setSequencerInboxMaxTimeVariation(
