...
export interface OneStepProverMathInterface extends utils.Interface {
...
export interface OneStepProverMath extends BaseContract {
  contractName: "OneStepProverMath";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneStepProverMathInterface;
