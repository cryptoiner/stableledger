...
import type {
  TestArbCustomToken,
  TestArbCustomTokenInterface,
} from "../TestArbCustomToken";
...
type TestArbCustomTokenConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TestArbCustomTokenConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TestArbCustomToken__factory extends ContractFactory {
  constructor(...args: TestArbCustomTokenConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  static readonly contractName: "TestArbCustomToken";
  public readonly contractName: "TestArbCustomToken";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TestArbCustomTokenInterface {
    return new utils.Interface(_abi) as TestArbCustomTokenInterface;
  }
  static connect(
    address: string,
