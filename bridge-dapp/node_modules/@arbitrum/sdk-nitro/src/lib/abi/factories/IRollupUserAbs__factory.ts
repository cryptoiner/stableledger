...
export class IRollupUserAbs__factory {
  static readonly abi = _abi;
  static createInterface(): IRollupUserAbsInterface {
    return new utils.Interface(_abi) as IRollupUserAbsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IRollupUserAbs {
    return new Contract(address, _abi, signerOrProvider) as IRollupUserAbs;
  }
}
