...
import type {
  BeaconProxyFactory,
  BeaconProxyFactoryInterface,
} from "../BeaconProxyFactory";
...
type BeaconProxyFactoryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: BeaconProxyFactoryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class BeaconProxyFactory__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<BeaconProxyFactory>;
  }
  ...
  attach(address: string): BeaconProxyFactory {
    return super.attach(address) as BeaconProxyFactory;
  }
  connect(signer: Signer): BeaconProxyFactory__factory {
    return super.connect(signer) as BeaconProxyFactory__factory;
  }
  static readonly contractName: "BeaconProxyFactory";
  public readonly contractName: "BeaconProxyFactory";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BeaconProxyFactoryInterface {
    return new utils.Interface(_abi) as BeaconProxyFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BeaconProxyFactory {
    return new Contract(address, _abi, signerOrProvider) as BeaconProxyFactory;
  }
}
