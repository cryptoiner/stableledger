...
import { L1ToL2MessageReaderOrWriter, L1ToL2MessageWaitResult, EthDepositMessage, EthDepositMessageWaitResult } from './L1ToL2Message';
...
export declare class L1TransactionReceipt implements TransactionReceipt {
     ...
     * @returns
     */
    getMessageDeliveredEvents(): MessageDeliveredEvent['args'][];
    /**
     * Get any InboxMessageDelivered events that were emitted during this transaction
     * @returns
     */
    getInboxMessageDeliveredEvent(): InboxMessageDeliveredEvent['args'][];
    /**
    ...
    private parseRetryableMessageData;
    private parseEthDepositData;
    getEthDepositMessages(l2Provider: Provider): Promise<EthDepositMessage[]>;
    /**
