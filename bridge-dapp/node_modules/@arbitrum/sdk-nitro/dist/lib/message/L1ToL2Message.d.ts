...
export declare class L1ToL2MessageReader extends L1ToL2Message {
     ...
     */
    getSuccessfulRedeem(): Promise<TransactionReceipt | null>;
    /**
     * Has this message expired. Once expired the retryable ticket can no longer be redeemed.
     * @returns
     */
    isExpired(): Promise<boolean>;
    protected receiptsToStatus(retryableCreationReceipt: TransactionReceipt | null, successfulRedeemReceipt: TransactionReceipt | null): Promise<L1ToL2MessageStatus>;
...
export declare class EthDepositMessage {
    ...
    static calculateDepositTxId(l2ChainId: number, messageNumber: BigNumber, toAddress: string, value: BigNumber): string;
    constructor(l2Provider: Provider, l2ChainId: number, messageNumber: BigNumber, to: string, value: BigNumber);
