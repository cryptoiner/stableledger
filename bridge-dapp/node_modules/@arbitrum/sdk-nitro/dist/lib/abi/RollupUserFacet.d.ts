...
export interface RollupUserFacetInterface extends utils.Interface {
    contractName: 'RollupUserFacet';
    functions: {
...
export interface RollupUserFacet extends BaseContract {
    contractName: 'RollupUserFacet';
    ...
    functions: {
        ...
        addToDeposit(stakerAddress: string, overrides?: PayableOverrides & {
        ...
        newStake(overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
