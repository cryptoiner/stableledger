...
export interface ValidatorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'returnOldDeposits', values: [string, string[]]): string;
    encodeFunctionData(functionFragment: 'timeoutChallenges', values: [string[]]): string;
    ...
    decodeFunctionResult(functionFragment: 'returnOldDeposits', data: BytesLike): Result;
...
export interface Validator extends BaseContract {
    ...
    functions: {
        ...
        returnOldDeposits(rollup: string, stakers: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        timeoutChallenges(challenges: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        returnOldDeposits(rollup: string, stakers: string[], overrides?: CallOverrides): Promise<void>;
        timeoutChallenges(challenges: string[], overrides?: CallOverrides): Promise<void>;
