...
export interface RollupTesterInterface extends utils.Interface {
    contractName: 'RollupTester';
    functions: {
    ...
    encodeFunctionData(functionFragment: 'getAdminFacet', values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: 'getUserFacet', values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: 'getAdminFacet', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'getUserFacet', data: BytesLike): Result;
...
export interface RollupTester extends BaseContract {
    contractName: 'RollupTester';
    ...
    functions: {
        ...
        initialize(_machineHash: BytesLike, _rollupParams: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], _stakeToken: string, _owner: string, _extraConfig: BytesLike, connectedContracts: string[], _facets: [string, string], sequencerInboxParams: [BigNumberish, BigNumberish], overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getStakerAddress(stakerNum: BigNumberish, overrides?: CallOverrides): Promise<string>;
        getUserFacet(overrides?: CallOverrides): Promise<string>;
        initialize(_machineHash: BytesLike, _rollupParams: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], _stakeToken: string, _owner: string, _extraConfig: BytesLike, connectedContracts: string[], _facets: [string, string], sequencerInboxParams: [BigNumberish, BigNumberish], overrides?: CallOverrides): Promise<void>;
        isMaster(overrides?: CallOverrides): Promise<boolean>;
        isStaked(staker: string, overrides?: CallOverrides): Promise<boolean>;
        isZombie(staker: string, overrides?: CallOverrides): Promise<boolean>;
        lastStakeBlock(overrides?: CallOverrides): Promise<BigNumber>;
