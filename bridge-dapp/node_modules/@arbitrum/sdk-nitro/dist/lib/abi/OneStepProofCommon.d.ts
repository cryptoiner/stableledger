...
export interface OneStepProofCommonInterface extends utils.Interface {
    contractName: 'OneStepProofCommon';
    functions: {
...
export interface OneStepProofCommon extends BaseContract {
    contractName: 'OneStepProofCommon';
