...
export interface OldOutboxInterface extends utils.Interface {
    contractName: 'OldOutbox';
    functions: {
    ...
    encodeFunctionData(functionFragment: 'outboxes', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'outboxesLength', values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: 'outboxesLength', data: BytesLike): Result;
...
export interface OldOutbox extends BaseContract {
    contractName: 'OldOutbox';
    ...
    functions: {
        ...
        executeTransaction(outboxIndex: BigNumberish, proof: BytesLike[], index: BigNumberish, l2Sender: string, destAddr: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, amount: BigNumberish, calldataForL1: BytesLike, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        calculateItemHash(l2Sender: string, destAddr: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, amount: BigNumberish, calldataForL1: BytesLike, overrides?: CallOverrides): Promise<string>;
        calculateMerkleRoot(proof: BytesLike[], path: BigNumberish, item: BytesLike, overrides?: CallOverrides): Promise<string>;
        executeTransaction(outboxIndex: BigNumberish, proof: BytesLike[], index: BigNumberish, l2Sender: string, destAddr: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, amount: BigNumberish, calldataForL1: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        outboxes(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
