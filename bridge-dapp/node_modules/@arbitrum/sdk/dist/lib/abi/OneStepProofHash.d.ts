...
export interface OneStepProofHashInterface extends utils.Interface {
    contractName: 'OneStepProofHash';
    functions: {
...
export interface OneStepProofHash extends BaseContract {
    contractName: 'OneStepProofHash';
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OneStepProofHashInterface;
