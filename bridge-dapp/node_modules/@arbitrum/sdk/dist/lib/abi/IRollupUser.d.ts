...
export interface IRollupUserInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "newStakeOnNewNode", values: [RollupLib.AssertionStruct, BytesLike, BigNumberish]): string;
...
export interface IRollupUser extends BaseContract {
    ...
    functions: {
        ...
        newStakeOnExistingNode(nodeNum: BigNumberish, nodeHash: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        newStakeOnNewNode(assertion: RollupLib.AssertionStruct, expectedNodeHash: BytesLike, prevNodeInboxMaxCount: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        newStakeOnNewNode(assertion: RollupLib.AssertionStruct, expectedNodeHash: BytesLike, prevNodeInboxMaxCount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        nodeHasStaker(nodeNum: BigNumberish, staker: string, overrides?: CallOverrides): Promise<boolean>;
        requireUnresolved(nodeNum: BigNumberish, overrides?: CallOverrides): Promise<void>;
        requireUnresolvedExists(overrides?: CallOverrides): Promise<void>;
