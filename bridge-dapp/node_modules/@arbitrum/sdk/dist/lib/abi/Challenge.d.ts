...
export interface ChallengeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'asserterTimeLeft', values?: undefined): string;
    encodeFunctionData(functionFragment: 'bisectExecution', values: [
        BytesLike[],
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: 'challengeState', values?: undefined): string;
    encodeFunctionData(functionFragment: 'challenger', values?: undefined): string;
    encodeFunctionData(functionFragment: 'challengerTimeLeft', values?: undefined): string;
    encodeFunctionData(functionFragment: 'clearChallenge', values?: undefined): string;
    encodeFunctionData(functionFragment: 'currentResponder', values?: undefined): string;
    encodeFunctionData(functionFragment: 'currentResponderTimeLeft', values?: undefined): string;
    encodeFunctionData(functionFragment: 'executors', values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'oneStepProveExecution', values: [
        BytesLike[],
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: 'proveContinuedExecution', values: [
        BytesLike[],
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: 'asserterTimeLeft', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'challengeState', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'challenger', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'challengerTimeLeft', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'proveContinuedExecution', data: BytesLike): Result;
...
export declare type AsserterTimedOutEvent = TypedEvent<[], {}>;
export declare type AsserterTimedOutEventFilter = TypedEventFilter<AsserterTimedOutEvent>;
export declare type BisectedEvent = TypedEvent<[
    string,
    BigNumber,
    BigNumber,
    string[]
...
export declare type BisectedEventFilter = TypedEventFilter<BisectedEvent>;
export declare type ChallengerTimedOutEvent = TypedEvent<[], {}>;
export declare type ChallengerTimedOutEventFilter = TypedEventFilter<ChallengerTimedOutEvent>;
export declare type ContinuedExecutionProvenEvent = TypedEvent<[], {}>;
export declare type ContinuedExecutionProvenEventFilter = TypedEventFilter<ContinuedExecutionProvenEvent>;
export declare type InitiatedChallengeEvent = TypedEvent<[], {}>;
export declare type InitiatedChallengeEventFilter = TypedEventFilter<InitiatedChallengeEvent>;
export declare type OneStepProofCompletedEvent = TypedEvent<[], {}>;
export declare type OneStepProofCompletedEventFilter = TypedEventFilter<OneStepProofCompletedEvent>;
export interface Challenge extends BaseContract {
    ...
    functions: {
        ...
        bisectExecution(_merkleNodes: BytesLike[], _merkleRoute: BigNumberish, _challengedSegmentStart: BigNumberish, _challengedSegmentLength: BigNumberish, _oldEndHash: BytesLike, _gasUsedBefore: BigNumberish, _assertionRest: BytesLike, _chainHashes: BytesLike[], overrides?: Overrides & {
        ...
        oneStepProveExecution(_merkleNodes: BytesLike[], _merkleRoute: BigNumberish, _challengedSegmentStart: BigNumberish, _challengedSegmentLength: BigNumberish, _oldEndHash: BytesLike, _initialMessagesRead: BigNumberish, _initialAccs: [BytesLike, BytesLike], _initialState: [BigNumberish, BigNumberish, BigNumberish], _executionProof: BytesLike, _bufferProof: BytesLike, prover: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        proveContinuedExecution(_merkleNodes: BytesLike[], _merkleRoute: BigNumberish, _challengedSegmentStart: BigNumberish, _challengedSegmentLength: BigNumberish, _oldEndHash: BytesLike, _gasUsedBefore: BigNumberish, _assertionRest: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        asserter(overrides?: CallOverrides): Promise<string>;
        asserterTimeLeft(overrides?: CallOverrides): Promise<BigNumber>;
        bisectExecution(_merkleNodes: BytesLike[], _merkleRoute: BigNumberish, _challengedSegmentStart: BigNumberish, _challengedSegmentLength: BigNumberish, _oldEndHash: BytesLike, _gasUsedBefore: BigNumberish, _assertionRest: BytesLike, _chainHashes: BytesLike[], overrides?: CallOverrides): Promise<void>;
        bridges(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        challengeState(overrides?: CallOverrides): Promise<string>;
        challenger(overrides?: CallOverrides): Promise<string>;
        challengerTimeLeft(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        isMaster(overrides?: CallOverrides): Promise<boolean>;
        lastMoveBlock(overrides?: CallOverrides): Promise<BigNumber>;
        oneStepProveExecution(_merkleNodes: BytesLike[], _merkleRoute: BigNumberish, _challengedSegmentStart: BigNumberish, _challengedSegmentLength: BigNumberish, _oldEndHash: BytesLike, _initialMessagesRead: BigNumberish, _initialAccs: [BytesLike, BytesLike], _initialState: [BigNumberish, BigNumberish, BigNumberish], _executionProof: BytesLike, _bufferProof: BytesLike, prover: BigNumberish, overrides?: CallOverrides): Promise<void>;
        proveContinuedExecution(_merkleNodes: BytesLike[], _merkleRoute: BigNumberish, _challengedSegmentStart: BigNumberish, _challengedSegmentLength: BigNumberish, _oldEndHash: BytesLike, _gasUsedBefore: BigNumberish, _assertionRest: BytesLike, overrides?: CallOverrides): Promise<void>;
        timeout(overrides?: CallOverrides): Promise<void>;
        turn(overrides?: CallOverrides): Promise<number>;
    };
    filters: {
        'AsserterTimedOut()'(): AsserterTimedOutEventFilter;
        AsserterTimedOut(): AsserterTimedOutEventFilter;
        'Bisected(bytes32,uint256,uint256,bytes32[])'(challengeRoot?: BytesLike | null, challengedSegmentStart?: null, challengedSegmentLength?: null, chainHashes?: null): BisectedEventFilter;
        Bisected(challengeRoot?: BytesLike | null, challengedSegmentStart?: null, challengedSegmentLength?: null, chainHashes?: null): BisectedEventFilter;
        'ChallengerTimedOut()'(): ChallengerTimedOutEventFilter;
        ChallengerTimedOut(): ChallengerTimedOutEventFilter;
        'ContinuedExecutionProven()'(): ContinuedExecutionProvenEventFilter;
        ContinuedExecutionProven(): ContinuedExecutionProvenEventFilter;
        'InitiatedChallenge()'(): InitiatedChallengeEventFilter;
        InitiatedChallenge(): InitiatedChallengeEventFilter;
        'OneStepProofCompleted()'(): OneStepProofCompletedEventFilter;
        OneStepProofCompleted(): OneStepProofCompletedEventFilter;
    };
    estimateGas: {
    ...
    populateTransaction: {
        ...
        executors(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initializeChallenge(_executors: string[], _resultReceiver: string, _executionHash: BytesLike, _maxMessageCount: BigNumberish, _asserter: string, _challenger: string, _asserterTimeLeft: BigNumberish, _challengerTimeLeft: BigNumberish, _sequencerBridge: string, _delayedBridge: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
