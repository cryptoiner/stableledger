...
export interface IRollupUserERC20Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "newStakeOnNewNode", values: [BigNumberish, RollupLib.AssertionStruct, BytesLike, BigNumberish]): string;
...
export interface IRollupUserERC20 extends BaseContract {
    ...
    functions: {
        ...
        newStakeOnNewNode(tokenAmount: BigNumberish, assertion: RollupLib.AssertionStruct, expectedNodeHash: BytesLike, prevNodeInboxMaxCount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        newStakeOnNewNode(tokenAmount: BigNumberish, assertion: RollupLib.AssertionStruct, expectedNodeHash: BytesLike, prevNodeInboxMaxCount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        nodeHasStaker(nodeNum: BigNumberish, staker: string, overrides?: CallOverrides): Promise<boolean>;
        requireUnresolved(nodeNum: BigNumberish, overrides?: CallOverrides): Promise<void>;
        requireUnresolvedExists(overrides?: CallOverrides): Promise<void>;
