...
export interface PrecompilesTesterInterface extends utils.Interface {
    contractName: 'PrecompilesTester';
    functions: {
...
export interface PrecompilesTester extends BaseContract {
    contractName: 'PrecompilesTester';
