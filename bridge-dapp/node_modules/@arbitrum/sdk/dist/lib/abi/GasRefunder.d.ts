...
export interface GasRefunderInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'lastContractRefund', values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: 'lastContractRefund', data: BytesLike): Result;
...
export interface GasRefunder extends BaseContract {
    ...
    functions: {
        ...
        lastContractRefund(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        lastContractRefund(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        onGasSpent(refundee: string, gasUsed: BigNumberish, calldataSize: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
