...
export interface BridgeMockInterface extends utils.Interface {
    ...
    functions: {
        ...
        'deliverMessageToInboxTest(uint8,address,uint256,uint256,uint256,bytes32)': FunctionFragment;
    ...
    encodeFunctionData(functionFragment: 'deliverMessageToInboxTest', values: [
        BigNumberish,
        string,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: 'deliverMessageToInboxTest', data: BytesLike): Result;
...
export interface BridgeMock extends BaseContract {
    ...
    functions: {
        ...
        deliverMessageToInboxTest(kind: BigNumberish, sender: string, blockNumber: BigNumberish, blockTimestamp: BigNumberish, gasPrice: BigNumberish, messageDataHash: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        deliverMessageToInboxTest(kind: BigNumberish, sender: string, blockNumber: BigNumberish, blockTimestamp: BigNumberish, gasPrice: BigNumberish, messageDataHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
