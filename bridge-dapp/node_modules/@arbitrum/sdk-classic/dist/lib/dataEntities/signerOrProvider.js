...
class SignerProviderUtils {
    static isSigner(signerOrProvider) {
        return signerOrProvider.signMessage !== undefined;
    }
    /**
    ...
    static getProviderOrThrow(signerOrProvider) {
        ...
        if (!maybeProvider)
            throw new errors_1.MissingProviderArbTsError('signerOrProvider');
    ...
    static async checkNetworkMatches(signerOrProvider, chainId) {
        ...
        if (providerChainId !== chainId) {
            throw new errors_1.ArbTsError(`Signer/provider chain id: ${providerChainId} doesn't match provided chain id: ${chainId}.`);
        }
    }
}
