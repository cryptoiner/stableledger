...
class EthBridger extends assetBridger_1.AssetBridger {
    async depositTxOrGas(params, estimate) {
        ...
        const gasEstimator = new L1ToL2MessageGasEstimator_1.L1ToL2MessageGasEstimator(params.l2Provider);
        const submissionPrice = (await gasEstimator.estimateSubmissionPrice(0, (_a = params.retryableGasOverrides) === null || _a === void 0 ? void 0 : _a.maxSubmissionPrice)).submissionPrice;
        const inbox = Inbox__factory_1.Inbox__factory.connect(this.l2Network.ethBridge.inbox, params.l1Signer);
        return (estimate ? inbox.estimateGas : inbox.functions).depositEth(submissionPrice, Object.assign({ value: params.amount }, (params.overrides || {})));
    }
    /**
    ...
    async withdrawTxOrGas(params, estimate) {
        if (!signerOrProvider_1.SignerProviderUtils.signerHasProvider(params.l2Signer)) {
            throw new errors_1.MissingProviderArbTsError('l2Signer');
        }
